...
The **Pearson's correlation coefficient,** ${r}$, can be calculated for any dataset with two continuous variables. However, before we calculate the correlation coefficient ${r}$ we should make sure that the following **assumptions** are met:
