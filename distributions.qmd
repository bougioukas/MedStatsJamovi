...
3.  If A and B are two mutually exclusive events or incompatible events, then **P(A ∪ B) = P(A) + P(B)** and **P(A ∩ B) = 0**.
:::
...
Venn diagrams allow us to understand combined events:

![](images/events.png){width="330" height="240"}
...
![](images/complement.png){width="230" height="140"}

The complement of Event A = {5, 6} is $A'$ = {1, 2, 3, 4} and the complement probability is:


$P(A')$ = 1-P(rolling a 5 or 6) = 1-P(rolling a 5) - P(rolling a 6) = 1- 1/6 - 1/6 = 2/3
:::
