...
## `r fa("rocket", fill = "orange")` Basic types and operations of events using set theory
...
**Inverse Events:** For any event A, "event A does not occur" is also an event. This event is called the inverse of event A or the complement of A, and is denoted by $\bar{A}$.

**Mutually Exclusive Events:** For any two events A and B, if events A and B cannot occur simultaneously, that is, A ∩ B =∅, then A and B are called mutually exclusive events.
:::
...
::: {.callout-caution collapse="true" icon="false"}
## `r fa("rocket", fill = "orange")` Probabilities involved in Bayes' theorem (Advanced)
...
plot(x,y, main="Normal Distribution", type = "l", lwd = 2,  xlab = "", ylab = "Probability Density", xaxt='n', bty="n")
...
plot(x,y1, main="Normal Distributions", type = "l", lwd = 3,  xlab = "", ylab = "Probability Density", xaxt='n', bty="n")
...
::: {.callout-tip icon="false"}
## `r fa("highlighter", fill = "steelblue")` Properties of Normal Distribution
...
plot(x,y, main="Standard Normal Distribution", type = "l", lwd = 2,  xlab = "Z", ylab = "Probability Density", bty="n")
axis(1, at = -4:4)
...
::: {.callout-caution collapse="true" icon="false"}
## `r fa("rocket", fill = "orange")` Understanding the formula of Standard Normal distribution
...
type='l', ylab="Probability Density", xlab="z",lwd=3,col="#522d80", bty="n")
...
curve(dnorm(x), -4, 4, xlab = "t", ylab = "Probability Density", bty="n")
...
curve(dchisq(x, df = 10), from = 0, to = 50, xlab = "chi-squared", ylab = "Probability Density", bty="n")
curve(dchisq(x, df = 15), col = "red", add = TRUE)
curve(dchisq(x, df = 20), col = "green", add = TRUE)
axis(2, at = seq(0, 0.1, by= 0.02))
text(10, 0.1, expression("df=10"))
text(15, 0.08, expression("df= 15"), col = "red")
text(24, 0.06, expression("df=20"), col = "green")
...
curve(df(x, df1 = 2, df2 = 1), from = 0, to = 5, col= 'black', xlab = "F", ylab = "Probability Density", bty="n")
curve(df(x, df1 = 4, df2 = 6), col= 'red', add = TRUE)
curve(df(x, df1 = 12, df2 = 12), col= 'green', add = TRUE)

axis(2, at = seq(0, 1, by= 0.2))
text(0.5, 0.9, expression("df1=2, df2=1"))
text(1.1, 0.6, expression("df1=4, df2=6"), col= 'red')
text(1.3, 0.8, expression("df1=12, df2=12"), col= 'green')
...
plot(h, freq=TRUE, main="Empirical distribution", xlab = "Birthweight (in Kg)", ylab="Relative Frequency", bty="n")
