...
Skewness values that are **negative** indicate a tail to the **left** (@fig-compare_skewness a), **zero** value indicate a **symmetric** distribution (@fig-compare_skewness b), while values that are **positive** indicate a tail to the **right** (@fig-compare_skewness c).
