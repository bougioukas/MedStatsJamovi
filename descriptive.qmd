...
**A. Mean (sd)** for data with **symmetric** distribution. A distribution, or data set, is symmetric if its left and right sides are mirror images.
...
## Describing associations between two continuous variables

It is convenient to use a single number to summarize a steadily increasing or decreasing association between two variables. A statistic that involves two continuous variables is the **correlation coefficient**. 
This idea originally proposed by Francis Galton but formally published in 1895 by Karl Pearson, one of the founders of modern statistics.
The concept of correlation implies that two variables covary. That is, **a change in variable X is associated with a change in variable Y**.
...
## Displaying associations between two continuous variables - Scatter plot

Visual inspection of a plot of coordinate points for the X and Y variables is necessary. Such a plot is called a **scatter plot**
and is illustrated in @fig-scatterplot.
