...
We can add labels to numerically coded values of categorical variables. Double-click on the variable name `sex`. We will get an extra menu open at the top of the Jamovi screen:

![Adding labels to numerically coded Values](images/labels.png)
