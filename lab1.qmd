...
This will open the menu shown in @fig-open_file. Select 'Open' and then 'This PC', and choose the excel file 'arrhythmia' from the files listed on 'Browse' which are stored on our computer:
