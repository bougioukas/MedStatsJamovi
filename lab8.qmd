...
$$ Risk \ Ratio = \frac{\frac{41}{90}}{\frac{16}{115}} =\frac{0.4556}{0.1391} = 3.27$$
Using Jamovi we get the following output (@fig-chi13):

![The relative risk with 95% condidence intervals.](images/chi13.png){#fig-chi13 width="55%"}

The risk of dying is 3.27 (95\% CI: 1.97, 5.44) times higher for patients with ulcerated tumors compared to non-ulcerated tumors. Note that the 95% confidence interval of the RR **does not include** the hypothesized null value of 1.
