...
![In the Analyses Tab select Exploration and click on Descriptives](images/descriptives1.png){#fig-descriptives1 width=90%}
...
![Transfer the `sex` variable into the `Variables` box. Check the `Frequency tables` box and unchecked all the other options for descriptive statistics.](images/descriptives4.png){#fig-descriptives4 width=75%}
...
from the top menu, as shown in @fig-descriptives1.


Now, select the variables `age` and `QRS` and drag them in the empty `Variables` box, as shown below:

![select the variables `age` and `QRS`](images/descriptives8.png){#fig-descriptives8 width=75%}
...
![Select Histograms, Box Plots, and Violin plots.](images/descriptives11.png){#fig-descriptives11 width=75%}
