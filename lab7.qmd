...
Drag the variable `WeightLoss` into the `Variables` box and split it by the `Diet` variable. Additionally, select `Variable across columns`, as shown below (@fig-diet1):
...
![In the Plots section select Density from Histograms.](images/diet3.png){#fig-diet3 width="70%"}
