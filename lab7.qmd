...
Drag the variable `WeightLoss` into the `Variables` box and split it by the `Diet` variable. Additionally, select `Variable across rows`, as shown below (@fig-diet1):
