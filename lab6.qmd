...
![The results of the Student's  t-test.](images/t_test7.png){#fig-t_test7 width="75%"}
...
The paired samples design can effectively reduce the effect of non-treatment factors and improve the efficiency of the experiment.
A paired samples t-test is used to estimate whether the means of two related measurements are significantly different from one another.
...
First, we have to calculate the differences $d_{i}= birth\_weight_i - discharge\_weight_i$ (@fig-paired2). For more details go to the section *11.6 Transforming data: Computing a new variable* in @sec-lab1.
...
Drag the variable `d` into the `Variables` box, as shown below (@fig-paired3):
