...
In this example, the main independent variable of interest is the `group` (salicylic acid plasters Vs usual scalpel debridement) and the dependent variable is the `complete_heal` (completely healed corns at three months post-randomization).
