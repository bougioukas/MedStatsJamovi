...
- Know the two main branches of Statistics, descriptive and inferential statistics.
...
Descriptive statistics include measures of frequency, measures of location and dispersion, and measures of association. They also include a description of the general shape of the distribution of the data. These terms will be explained in @sec-descriptive.
...
DT::datatable(data_corn, extensions = 'Scroller', 
              options = list(deferRender = F, dom = 't', columnDefs = list(list(className = 'dt-center', targets = 1:20)), scrollY = 202, scroller = TRUE, scrollX = T, pageLength = 10))
...
**A.** A dependent variable is the variable being tested and measured in a scientific experiment (outcome).
...
d. Assignment of a person in three groups in a clinical trial
