...
$\color{grey}{Grey\ color}:$ Exercises with embedded solutions.
...
This is a possible solution to the exercise.
:::
:::
...
flowchart LR
    ...
    B --- G[Measures of association: <br/> e.g., correlation coefficients]
    C --- H[Estimation]
...
Descriptive statistics include measures of frequency, measures of location and dispersion, and measures of association. They also include a description of the general shape of the distribution of the data. These terms will be explained in the corresponding chapters.

### Inferential Statistics

Inferential statistics include estimation and hypothesis testing. They aim at generalizing a measure taken on a small number of cases that have been observed, to a larger set of cases that have not been observed. Using the terms explained above, we could reformulate this aim, and say that inferential statistics aim at generalizing observations made on a sample to a whole population.
...
(b) It helps to **make a decision**: if a person has hypertension, then they will get treatment, and this is easier if high blood pressure has been categorized. However, this dichotomization clearly leads to a loss of information.
